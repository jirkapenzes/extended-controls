 ...
 * Time: 0:58
 */
public class ButtonBackgroundColorStyle implements ImageButtonActionStyle {
    ...
    public ButtonBackgroundColorStyle() {
        this(new Color(181, 190, 214));
    }

    public ButtonBackgroundColorStyle(Color hoverBackgroundColor) {
        this(hoverBackgroundColor, new Color(8, 36, 107), new Color(142, 224, 130), new Color(72, 122, 65));
    }

    public ButtonBackgroundColorStyle(Color hoverBackgroundColor, Color pressedBackgroundColor, Color pressedBorderColor) {
        this(hoverBackgroundColor, new Color(8, 36, 107), pressedBackgroundColor, pressedBorderColor);
    }

    public ButtonBackgroundColorStyle(Color hoverBackgroundColor, Color hoverBorderColor, Color pressedBackgroundColor, Color pressedBorderColor) {
